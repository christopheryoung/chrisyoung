...
1. Collate your manuscripts against some reference text that you hope is not
   ...
   provisionally considered "errors." As work continues and readings are
   reassessed our best guess as to which readings are errors may change. What
   stays constant is that shared readings are only considered evidence of
   provenance when they are errors.
...
to the textual tradition as well. And see @reynolds2013scribes, p. 218 for further
...
**Insufficiency**: It is not always clear in practice which variants are
monogenetic and which polygenetic. A conservative approach may leave us with "a
much reduced data set, where the correct stemmatic theory is bound to be
underdetermined by data," as a friend recently complained to me.
...
@reynolds2013scribes, p. 193 credit this point originally to Ludwig Traube
